...
class PromptChecker:
    ...
    def __init__(self, client) -> None:
        ...
        7. Check if this line is present in the prompt. If it is not present add these exact same lines without altering them to the end of the query. The line is: "Give me the whole implementation. Also see to it that the window and the sprites are sized appropriately"
