...
class SpriteGeneratorAgent:
    ...
    def __init__(self, client) -> None:
        ...
        1. Identify only the important images required for the game. 
        ...
        4. Also generate a good name for the game. Do not use any special characters in the name of the game. The key for the name of the game in the JSON response should strictly be 'name'. 
        5. No need to provide Implementation

        Example of the JSON Object: 

        {\"name\": \"Street Racer\",\"car\": \"A green colored car\", \"obstacles\": \"Brown boulders\", \"background\": \"A road with yellow colored strips to divide it into two different lanes\"}
        """
